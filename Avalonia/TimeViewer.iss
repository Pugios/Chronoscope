; Installer for the Avalonia build. Same AppId as the MAUI installer, so it upgrades an existing
; install in place - and the app reads the same data folder, so tags and rules carry over.
