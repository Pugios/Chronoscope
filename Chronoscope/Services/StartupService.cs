...
//
//  - HKCU\...\Run holds the command line. Its presence is what puts Chronoscope on Task Manager's
...
// the registry alone says how Chronoscope starts and there is nothing to keep in step with it.
// The installer writes the same value (Chronoscope.iss) and removes both on uninstall.
public class StartupService
{
    ...
    private static void WriteWindows(bool enabled, bool minimized)
    {
        ...
        string exe = Environment.ProcessPath
            ?? throw new InvalidOperationException("The path of Chronoscope.exe is unknown.");
